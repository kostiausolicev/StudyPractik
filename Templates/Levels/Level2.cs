...
{
    public class Level2 : AbstractionLevel
    {
        ...
        */
        public override List<Objects.Abstract.AbstractInteractLet> interactLets { get; set; } = new List<Objects.Abstract.AbstractInteractLet>{
            new MovingLet(new string[]{"##",}, 58, 11, Direction.Left),
            new MovingLet(new string[]{"##",}, 56, 12, Direction.Left),
            new MovingLet(new string[]{"##",}, 54, 13, Direction.Left),
            new MovingLet(new string[]{"##",}, 52, 14, Direction.Left),

            new MovingLet(new string[]{"##",}, 20, 11, Direction.Left),
            new MovingLet(new string[]{"##",}, 21, 12, Direction.Left),
            new MovingLet(new string[]{"##",}, 22, 13, Direction.Left),

            new MovingLet(new string[]{"###",}, 60, 4 ,Direction.Right),
            new MovingLet(new string[]{"###",}, 60, 5, Direction.Right),
            new MovingLet(new string[]{"###",}, 60, 6, Direction.Right),
            new MovingLet(new string[]{"###",}, 60, 8, Direction.Right),
            new MovingLet(new string[]{"###",}, 60, 7, Direction.Right),
            new Box(new string[] { "######", "######", "######"}, 80, 37),
            new Box(new string[] {"####", "   #", "   #", "   #" }, 30, 35),
            new Box(new string[] {"#", "#", "#", "#", "#" }, 25, 35),
            new RetryBox(new string[] {"<>", "<>", "<>"}, 41, 11),
            new RetryBox(new string[] {"<", "<", "<"}, 26, 11),
            new RetryBox(new string[] {">", ">", ">"}, 4, 11),
            new RetryBox(new string[] {">", ">", ">"}, 36, 7),
